...
public:
    int peopleAwareOfSecret(int n, int delay, int forget) {
        ...
        for(int i = 2; i <= n; i ++) {
            ...
            // new people of share count learns from same share_count hence put it in back.
            // Since these are new people only eligible for the know phase hence add to the know count.
            if(!share.empty()) {
